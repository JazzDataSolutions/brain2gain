...
type UsersSearchParams = z.output<typeof usersSearchSchema>; // Esto será { page: number }
...
function UsersTable() {
  ...
  const setPage = (newPage: number) => {
     ...
     navigate({ search: ((_prev: UsersSearchParams) => ({ page: newPage })) as any });
