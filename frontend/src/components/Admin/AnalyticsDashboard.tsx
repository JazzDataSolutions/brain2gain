...
const AnalyticsDashboard: React.FC = () => {
  ...
  const fetchCohortData = async () => {
    try {
      const response = await fetch(
        "/api/v1/analytics/cohorts/retention?months_back=6",
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
  ...
  const fetchFunnelData = async () => {
    try {
      const response = await fetch(
        "/api/v1/analytics/funnel/conversion?days=30",
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
  ...
  return (
    <Box p={6}>
      <VStack spacing={6} align="stretch">
            ...
            <Box>
              ...
              <HStack spacing={4} align="center">
                ...
                {alertsData && alertsData.total_alerts > 0 && (
                  <Badge
                    colorScheme={
                      alertsData.critical_alerts > 0 ? "red" : "orange"
                    }
                    variant="solid"
                    display="flex"
                    alignItems="center"
                  ...
                  >
                    ...
                    {alertsData.total_alerts} Alert
                    {alertsData.total_alerts > 1 ? "s" : ""}
                  </Badge>
                )}
              </HStack>
            </Box>
        ...
        {(!alertsData || alertsData.alerts.length === 0) &&
          financialData?.inventory?.low_stock_products &&
          financialData.inventory.low_stock_products > 0 && (
            <Alert status="warning">
              <AlertIcon />
              <AlertTitle>Inventory Alert!</AlertTitle>
              <AlertDescription>
                {financialData?.inventory?.low_stock_products} products are
        ...
        {(!alertsData || alertsData.alerts.length === 0) &&
          financialData?.inventory?.out_of_stock_products &&
          financialData.inventory.out_of_stock_products > 0 && (
            <Alert status="error">
              <AlertIcon />
              <AlertTitle>Stock Alert!</AlertTitle>
              <AlertDescription>
                {financialData?.inventory?.out_of_stock_products} products are
                out of stock.
              </AlertDescription>
            </Alert>
          )}
                  ...
                  <Box>
                    ...
                    >
                      <Box
                        ...
                        bg="green.400"
                        w={`${Math.min(
                          ((financialData?.revenue.mrr || 0) / 50000) * 100,
                          100,
                        )}%`}
                        borderRadius="full"
                      />
              ...
              <CardBody>
                <VStack align="stretch" spacing={3}>
                  <HStack justify="space-between">
                    ...
                    <Badge
                      colorScheme={
                        (financialData?.conversion.churn_rate || 0) < 10
                          ? "green"
                          : (financialData?.conversion.churn_rate || 0) < 15
                            ? "orange"
                            : "red"
                      }
                      size="sm"
                  ...
                  <HStack spacing={4}>
                    <VStack align="start" spacing={1} flex={1}>
                      ...
                      <Text fontSize="lg" fontWeight="bold" color="red.500">
                        {formatPercentage(
                          financialData?.conversion.churn_rate || 0,
                        )}
                      </Text>
                    </VStack>
                    <VStack align="start" spacing={1} flex={1}>
                      ...
                      <Text fontSize="lg" fontWeight="bold" color="green.500">
                        {formatPercentage(
                          financialData?.conversion.repeat_customer_rate || 0,
                        )}
                      </Text>
                    </VStack>
                  </HStack>
                  <Box>
                    ...
                    >
                      <Box
                        ...
                        w={`${Math.max(
                          100 - (financialData?.conversion.churn_rate || 0),
                          0,
                        )}%`}
                        borderRadius="full"
                      />
              ...
              <CardBody>
                <VStack align="stretch" spacing={3}>
                  <HStack justify="space-between">
                    ...
                    <Badge
                      colorScheme={
                        (financialData?.conversion.conversion_rate || 0) > 5
                          ? "green"
                          : (financialData?.conversion.conversion_rate || 0) > 2
                            ? "orange"
                            : "red"
                      }
                      size="sm"
                    >
                      {formatPercentage(
                        financialData?.conversion.conversion_rate || 0,
                      )}
                    </Badge>
                  </HStack>
                    ...
                    <Box>
                      ...
                      >
                        <Box
                          ...
                          w={`${
                            100 -
                            (financialData?.conversion.cart_abandonment_rate ||
                              0)
                          }%`}
                          borderRadius="full"
                        />
            ...
            <CardBody>
              <VStack align="stretch" spacing={4}>
                ...
                <HStack justify="space-between">
                  ...
                  <Badge
                    colorScheme={
                      financialData?.orders?.pending_orders &&
                      financialData.orders.pending_orders > 10
                        ? "orange"
                        : "gray"
                    }
                    fontSize="md"
            ...
            <CardBody>
              <VStack align="stretch" spacing={4}>
                ...
                <HStack justify="space-between">
                  ...
                  <Badge
                    colorScheme={
                      financialData?.customers?.customer_conversion_rate &&
                      financialData.customers.customer_conversion_rate > 50
                        ? "green"
                        : financialData?.customers?.customer_conversion_rate &&
                            financialData.customers.customer_conversion_rate >
                              25
                  ...
                  >
                    {formatPercentage(
                      financialData?.customers?.customer_conversion_rate || 0,
                    )}
                  </Badge>
                </HStack>
              </VStack>
              ...
              <VStack align="stretch" spacing={4}>
                ...
                <HStack justify="space-between">
                  ...
                  <Text fontWeight="bold">
                    {formatCurrency(
                      financialData?.inventory.total_inventory_value || 0,
                    )}
                  </Text>
                </HStack>
              </VStack>
                ...
                <VStack align="stretch" spacing={3}>
                  <Box>
                    ...
                    >
                      <Box
                        h="full"
                        bg={
                          financialData?.conversion?.conversion_rate &&
                          financialData.conversion.conversion_rate > 5
                            ? "green.400"
                            : financialData?.conversion?.conversion_rate &&
                                financialData.conversion.conversion_rate > 2
                              ? "orange.400"
                              : "red.400"
                        }
                        w={`${Math.min(
                  ...
                  <Box>
                    <HStack justify="space-between" mb={1}>
                      ...
                      <Text fontSize="sm" fontWeight="bold">
                        {formatPercentage(
                          financialData?.conversion?.cart_abandonment_rate || 0,
                        )}
                      </Text>
                    </HStack>
                    <Box
                    ...
                    >
                      <Box
                        ...
                        bg={
                          financialData?.conversion?.cart_abandonment_rate &&
                          financialData.conversion.cart_abandonment_rate > 70
                            ? "red.400"
                            : financialData?.conversion
                  ...
                  <Box>
                    ...
                    >
                      <Box
                        h="full"
                        bg={
                          financialData?.conversion?.repeat_customer_rate &&
                          financialData.conversion.repeat_customer_rate > 30
                            ? "green.400"
                            : financialData?.conversion?.repeat_customer_rate &&
                                financialData.conversion.repeat_customer_rate >
                                  15
                  ...
                  <Box>
                    <HStack justify="space-between" mb={1}>
                      ...
                      <Text
                        ...
                        fontWeight="bold"
                        color={
                          financialData?.conversion?.churn_rate &&
                          financialData.conversion.churn_rate > 15
                            ? "red.500"
                            : financialData?.conversion?.churn_rate &&
                                financialData.conversion.churn_rate > 10
                              ? "orange.500"
                              : "green.500"
                        }
                      >
