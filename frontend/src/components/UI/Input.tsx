...
const inputVariants = cva(
  "block w-full rounded-md shadow-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        default: "border border-secondary-300 bg-white text-secondary-900 placeholder-secondary-400 focus:border-primary-500 focus:ring-primary-500",
        error: "border border-error-300 bg-white text-secondary-900 placeholder-secondary-400 focus:border-error-500 focus:ring-error-500",
        success: "border border-success-300 bg-white text-secondary-900 placeholder-secondary-400 focus:border-success-500 focus:ring-success-500",
      },
      size: {
