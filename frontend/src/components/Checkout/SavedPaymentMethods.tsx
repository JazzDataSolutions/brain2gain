            ...
            <VStack spacing={3} align="stretch">
              {savedMethods.map((method) => (
                <Card
                  ...
                  border="2px"
                  borderColor={
                    selectedId === method.id ? "blue.200" : "gray.200"
                  }
                  cursor="pointer"
                          ...
                          <HStack spacing={3} flex={1}>
                            ...
                            <VStack align="start" spacing={1}>
                              ...
                              <Text fontSize="sm" color="gray.600">
                                ...
                                {method.last4} • {method.expiryMonth}/
                                {method.expiryYear}
                              </Text>
                            </VStack>
                          </HStack>
        ...
        <Box bg="green.50" p={3} rounded="md">
          <HStack>
            ...
            <Text fontSize="sm" color="green.700">
              <strong>Seguro:</strong> Tus métodos de pago están protegidos con
              encriptación de grado bancario. Nunca almacenamos números de
              tarjeta completos.
            </Text>
          </HStack>
        </Box>
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Text color="gray.600" mb={4}>
              Esta funcionalidad se implementará próximamente con integración
              segura de Stripe y PayPal.
            </Text>
          </ModalBody>
          <ModalFooter>
