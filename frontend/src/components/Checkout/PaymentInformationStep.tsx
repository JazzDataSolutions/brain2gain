...
import { FiCreditCard, FiBookmark } from 'react-icons/fi'
    ...
    <Box>
      <VStack spacing={6} align="stretch">
            ...
            <TabPanel p={0} pt={6}>
              <VStack spacing={6} align="stretch">
                  ...
                  >
                    <VStack spacing={3} align="stretch">
                      ...
                      <Box 
                        ...
                        rounded="md" 
                        border="2px" 
                        borderColor={paymentMethod === 'stripe' ? 'blue.200' : 'gray.200'}
                        cursor="pointer"
                      >
                        <HStack justify="space-between">
                          <HStack>
                            ...
                            <Text fontWeight="medium">Tarjeta de Crédito/Débito</Text>
                          </HStack>
                          <HStack spacing={2}>
                            <Badge colorScheme="green">Más Popular</Badge>
                            <Text fontSize="xs" color="gray.500">Visa, MC, Amex</Text>
                          </HStack>
                        </HStack>
                      </Box>
                      ...
                      <Box 
                        ...
                        rounded="md" 
                        border="2px" 
                        borderColor={paymentMethod === 'paypal' ? 'blue.200' : 'gray.200'}
                        cursor="pointer"
                      >
                        <HStack justify="space-between">
                          <HStack>
                      ...
                      <Box 
                        p={4} 
                        bg={paymentMethod === 'bank_transfer' ? 'blue.50' : cardBg} 
                        rounded="md" 
                        border="2px" 
                        borderColor={paymentMethod === 'bank_transfer' ? 'blue.200' : 'gray.200'}
                        cursor="pointer"
                      >
                        <HStack justify="space-between">
                          <HStack>
                ...
                {paymentMethod === 'stripe' && (
                  <Box p={6} bg={cardBg} rounded="lg" border="1px" borderColor="gray.200">
                    <VStack spacing={4} align="stretch">
                      <Text fontWeight="semibold" mb={2}>Información de la Tarjeta</Text>

              <FormControl isInvalid={!!errors.cardholderName}>
                <FormLabel htmlFor="cardholderName">Nombre del Tarjetahabiente *</FormLabel>
                <Input
                  id="cardholderName"
                  placeholder="Nombre como aparece en la tarjeta"
                  bg={inputBg}
                  {...register('cardholderName', {
                    required: paymentMethod === 'stripe' ? 'El nombre es requerido' : false,
                  })}
                />
                <FormErrorMessage>{errors.cardholderName?.message}</FormErrorMessage>
              </FormControl>
              ...
              <FormControl isInvalid={!!errors.cardNumber}>
                ...
                <Input
                  ...
                  bg={inputBg}
                  {...register('cardNumber', {
                    required: paymentMethod === 'stripe' ? 'El número de tarjeta es requerido' : false,
                    pattern: {
                      value: /^[\d\s]{16,19}$/,
              ...
              <Grid templateColumns="2fr 1fr" gap={4}>
                <GridItem>
                  <FormControl isInvalid={!!errors.expiryDate}>
                    <FormLabel htmlFor="expiryDate">Fecha de Vencimiento *</FormLabel>
                    <Input
                      id="expiryDate"
                      placeholder="MM/AA"
                      maxLength={5}
                      bg={inputBg}
                      {...register('expiryDate', {
                        required: paymentMethod === 'stripe' ? 'La fecha de vencimiento es requerida' : false,
                        pattern: {
                ...
                <GridItem>
                  <FormControl isInvalid={!!errors.cvv}>
                    ...
                    <Input
                      ...
                      bg={inputBg}
                      {...register('cvv', {
                        required: paymentMethod === 'stripe' ? 'El CVV es requerido' : false,
                        pattern: {
                          value: /^\d{3,4}$/,
                          message: '3-4 dígitos',
                        },
        ...
        {paymentMethod === 'paypal' && (
          <Box p={6} bg="blue.50" rounded="lg" border="1px" borderColor="blue.200">
        ...
        {paymentMethod === 'bank_transfer' && (
          <Box p={6} bg="orange.50" rounded="lg" border="1px" borderColor="orange.200">
            <VStack spacing={3} align="start">
              ...
              <Text fontSize="sm" color="gray.600">
                ...
                Tu pedido será procesado una vez que confirmemos el pago (2-3 días hábiles).
              </Text>
              <Alert status="warning" size="sm">
                <AlertIcon />
                <AlertDescription fontSize="sm">
                  Los productos se reservarán por 5 días. Pasado este tiempo, el pedido será cancelado.
                </AlertDescription>
              </Alert>
            </VStack>
          </Box>
