...
from app.models import Customer, SalesOrder, Transaction, OrderStatus, TransactionType
...
class CohortAnalysisService:
    ...
    def calculate_product_adoption_cohorts(self, product_category: Optional[str] = None) -> Dict:
        """
