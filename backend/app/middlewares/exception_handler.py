...
class ExceptionHandlerMiddleware:
    ...
    def _register_handlers(self):
        ...
        self.app.add_exception_handler(RequestValidationError, self._validation_exception_handler)
        self.app.add_exception_handler(ValidationError, self._pydantic_validation_handler)
