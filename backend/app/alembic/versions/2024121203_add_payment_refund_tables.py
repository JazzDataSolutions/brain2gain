...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_method", sa.String(50), nullable=False
    ...
    op.create_index(
        "idx_payments_stripe_intent", "payments", ["stripe_payment_intent_id"]
    )
    ...
    op.create_check_constraint(
        "ck_payments_currency_valid", "payments", "currency IN ('MXN', 'USD', 'EUR')"
    )
