...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Migration tracking
        sa.Column(
            "migrated_from_sales_order_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "product_name", sa.String(200), nullable=False
        ),  # Denormalized for history
        sa.Column(
            "product_sku", sa.String(100), nullable=False
        ),  # Denormalized for history
        ...
        # Migration tracking
        sa.Column(
            "migrated_from_sales_item_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
    )
